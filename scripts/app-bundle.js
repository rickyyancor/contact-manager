...
define('contact-detail',['exports', 'aurelia-framework', 'aurelia-event-aggregator', './web-api', './messages', './utility', 'aurelia-http-client'], function (exports, _aureliaFramework, _aureliaEventAggregator, _webApi, _messages, _utility, _aureliaHttpClient) {
  'use strict';
  ...
  var ContactDetail = exports.ContactDetail = (_dec = (0, _aureliaFramework.inject)(_webApi.WebAPI, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    ...
    ContactDetail.prototype.save = function save() {
      ...
      var client = new _aureliaHttpClient.HttpClient().configure(function (x) {
        ...
        x.withParams({ abc: _this2.contact });
      });

      client.get('/aurelia').then(function (data) {
        console.log('click a save luego de hacer el cliente: ' + data.response);
        _this2.contact.mensaje = data.response;
      });
...
define('web-api',['exports'], function (exports) {
  ...
  var contacts = [{
    ...
    firstName: 'Ricky ',
    lastName: 'Yancor',
    email: 'rickyyancor190@gmail.com',
    phoneNumber: '41222688'
  }, {
    id: getId(),
    firstName: 'Clive',
    lastName: 'Lewis',
